...
import useTranslatetX from '@components/SaleHomePage/translateXImage';
import { useEffect } from 'react';



function SaleHomePage() {
    const { container, boxContent, boxImg, title, des } = styles;

    const { translateXPosition } = useTranslatetX();
